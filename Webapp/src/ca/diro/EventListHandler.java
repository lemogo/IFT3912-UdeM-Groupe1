...
public class EventListHandler extends RequestHandler {
	...
	public void handle(String target, Request baseRequest,
		...
		try
		{
			...
			if(!(
					pathInfo.endsWith("/liste-des-evenements")||pathInfo.endsWith("/liste-des-evenements.html")||
					pathInfo.endsWith("/liste-des-evenements/passes")||pathInfo.endsWith("/liste-des-evenements/passes.html")||
					pathInfo.endsWith("/liste-des-evenements/annules")||pathInfo.endsWith("/liste-des-evenements/annules.html")
)) {
				return;
			}
